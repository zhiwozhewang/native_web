...
// ignore_for_file: unused_element, deprecated_member_use, deprecated_member_use_from_same_package, use_function_type_syntax_for_parameters, unnecessary_const, avoid_init_to_null, invalid_override_different_defaultvalues_named, prefer_expression_function_bodies, annotate_overrides, invalid_annotation_target
...
class _$APIErrorCopyWithImpl<$Res> implements $APIErrorCopyWith<$Res> {
  _$APIErrorCopyWithImpl(this.value, this.then);

  final APIError value;
  // ignore: unused_field
  final $Res Function(APIError) then;
}
...
class __$InvalidApiKeyCopyWithImpl<$Res> extends _$APIErrorCopyWithImpl<$Res>
  ...
  __$InvalidApiKeyCopyWithImpl(
      _InvalidApiKey value, $Res Function(_InvalidApiKey) then)
      : super(value, (v) => then(v as _InvalidApiKey));

  @override
  _InvalidApiKey get value => super.value as _InvalidApiKey;
}
...
class __$NoInternetConnectionCopyWithImpl<$Res>
  ...
  __$NoInternetConnectionCopyWithImpl(
      _NoInternetConnection value, $Res Function(_NoInternetConnection) then)
      : super(value, (v) => then(v as _NoInternetConnection));

  @override
  _NoInternetConnection get value => super.value as _NoInternetConnection;
}
...
class __$NotFoundCopyWithImpl<$Res> extends _$APIErrorCopyWithImpl<$Res>
  ...
  __$NotFoundCopyWithImpl(_NotFound value, $Res Function(_NotFound) then)
      : super(value, (v) => then(v as _NotFound));

  @override
  _NotFound get value => super.value as _NotFound;
}
...
class __$UnknownCopyWithImpl<$Res> extends _$APIErrorCopyWithImpl<$Res>
  ...
  __$UnknownCopyWithImpl(_Unknown value, $Res Function(_Unknown) then)
      : super(value, (v) => then(v as _Unknown));

  @override
  _Unknown get value => super.value as _Unknown;
}
